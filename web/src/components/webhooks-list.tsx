          ...
          {webhooks.map((webhook) => {
            return (
              <WebhooksListItem 
                ...
                isWebhoookChecked={checkedWebhooksIds.includes(webhook.id)}
              />
            )
          })}
        </div>
      ...
      {!!generatedHandlerCode && (
        <Dialog.Root defaultOpen>
          ...
          <Dialog.Content className='flex items-center justify-center fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] -translate-x-1/2 -translate-y-1/2 z-40'>
            <div className='bg-zinc-900 w-[600px] p-4 rounded-lg border border-zinc-800 max-w-[400px] overflow-y-auto'>
